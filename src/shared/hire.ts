 ...
 * `goblinsgoldhoard://hire?src=<https-url>` deep link or an in-app file picker.
 *
...
export interface HireManifest {
  /** Spec tag; exactly `goblins-gold-hoard/hire@1` for this version. */
...
/** Parse a `goblinsgoldhoard://hire?src=<https-url>` deep link. Returns the https
