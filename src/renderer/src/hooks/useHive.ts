...
const INITIAL_GOD_PROMPT = [
  "You're online as Gruk, the goblin overseer of the warren. Get oriented, then start running the floor:",
...
function enrichTaskPrompt(text: string): string {
  return [
    ...
    'self-contained prompt to Gruk via an outbox message with "to":"god". Do not do the task yourself.)'
  ].join('\n');
}
