...
const REPO = 'mx1010/goblins-gold-hoard';
...
const SIMULATED_NOTES = `# Goblin's Gold Hoard v9.9.9

**A local hive of Claude Code, Antigravity, Codex, Grok & Copilot agents that run themselves** —
messaging, routing, and remembering, coordinated by your clone, Gruk, who you talk to.
